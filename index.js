...
async function connectToWA() {
  console.log("Connecting RASHIMKA-MD 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ RASHIMKA-MD connected to WhatsApp');

      const up = `DANUWA-MD connected ✅\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://github.com/Rashmikahiru/Rashmika/blob/main/images/IMG_20250722_140722.jpg` },
        caption: up
      });
...
app.get("/", (req, res) => {
  res.send("Hey, RASHMIKA-MD started✅");
});
